...
🛠️ Tech Stack & Tools 
Software & Database Development: web and mobile development (JavaScript, PHP, etc) and structured database management (MySQL, XAMPP, Cloud Database). Information Systems & Business Analysis: Skilled in business architecture modeling (Archi), SDLC methodologies, and enterprise system implementation (ERP & DSS). 
UI/UX Design & IT Infrastructure: Adept at designing digital interfaces (Figma, Canva, Photoshop) and understanding foundational network infrastructure (Cisco Packet Tracer).

📫 Contact 
Email: yoemie08@gmail.ccom 
LinkedIn: www.linkedin.com/in/yoemie-a8036a3aa
