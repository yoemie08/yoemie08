...
- Software & Database Development: web and mobile development (JavaScript, PHP, etc) and structured database management (MySQL, XAMPP, Cloud Database).
- Information Systems & Business Analysis: Skilled in business architecture modeling (Archi), SDLC methodologies, and enterprise system implementation (ERP & DSS). 
